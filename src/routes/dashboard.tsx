...
function Dashboard() {
  ...
  const [form, setForm] = useState({
    title: "",
    category: "wedding" as EventCategoryValue,
    location: "",
    event_date: "",
    description: "",
  });
      ...
      <div className="container mx-auto px-4 py-10">
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="mt-1 text-muted-foreground">
              All events you host or have been invited to.
            </p>
          </div>
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          <DialogContent className="max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle className="font-serif text-2xl">Create your event</DialogTitle>
            </DialogHeader>
            <form onSubmit={createEvent} className="space-y-4">
              <div>
                ...
                <Select
                  value={form.category}
                  onValueChange={(v) => setForm({ ...form, category: v as EventCategoryValue })}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between">
                    ...
                    <span
                      className={`rounded-full px-3 py-1 text-xs font-medium ${isHost ? "gradient-gold" : "bg-secondary text-secondary-foreground"}`}
                    >
                      {isHost ? "Host" : "Member"}
                    </span>
                  </div>
